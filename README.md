...
<p>
            🚀 Minha jornada na tecnologia começou com a graduação em <span class="highlight">Análise e Desenvolvimento de Sistemas</span> e, para aprofundar ainda mais meus conhecimentos teóricos e técnicos, atualmente curso <span class="highlight">Ciência da Computação</span>.
        </p>

<p>
            💻 Meu foco está na união estratégica de dois mundos: a construção de interfaces modernas e intuitivas no <span class="highlight">Front-end</span> e a inteligência da <span class="highlight">Análise de Dados</span>. Acredito que um sistema eficiente não deve apenas ser funcional, mas também visualmente impecável e guiado por dados.
</p>

<p>
            🤖 Sou entusiasta de <span class="highlight">automação</span> e estou constantemente explorando como a tecnologia pode simplificar processos complexos. Meu próximo grande passo é a especialização em <span class="highlight">Inteligência Artificial</span>, onde pretendo integrar modelos de IA para criar soluções inovadoras.
</p>
